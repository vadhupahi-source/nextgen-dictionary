...
export default function DarkModeToggle() {
  const theme = useSyncExternalStore(subscribeToStorage, getTheme, () => "light" as const);
  ...
  return (
    <button
      onClick={toggle}
      className="relative w-14 h-7 rounded-full bg-gray-200 dark:bg-slate-600 transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-primary-light"
